...
const PNG_FILE_URL='https://forms.gle/uo7zwjeRpcjjWJiDA';
window.open(PNG_FILE_URL, '_blank');
        ...
        <div className="app-container">
            ...
            <div className="education">
                ...
                <div className="coursecards">
                    ...
                    <div className="certi">
                    {isChecked1&&isChecked2&&isChecked3&&isChecked4&&isChecked5&&isChecked6&&(<button id="certificate" onClick={()=>downloadFileAtURL(PNG_FILE_URL)}>GET YOUR CERTIFICATE</button>)}
                    </div>
                </div>
            </div>
            {showVideo && (
